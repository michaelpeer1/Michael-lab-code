function [names, onsets, durations]=create_ER_design_from_log_gradient(filenames, times_start_TRs, TR, len_stimulus, len_end_rest, num_removed_volumes)
% [names, onsets, durations]=create_ER_design_from_log_gradient(filenames, times_start_TRs, TR, len_stimulus, len_end_rest, num_removed_volumes)
%
