function [names, onsets, durations]=create_domain_design_from_design(design_filename)
...
% with distances
% (uses the results of the create_design functions)
%
...
load(['c:\expyvr\log\' design_filename '_design.mat']);
names_new={'pe','pl','ti'};
...
save(['c:\expyvr\log\' design_filename '_domain_design.mat'],'names','onsets','durations');