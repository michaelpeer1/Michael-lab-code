...
% MICHAEL COMMENTS:
% This function creates a linear register, and in each stage the state of
% the register is recorded and it is moved to the left, and the value
% entering is a modulu of two other values.
% 'baseVal' is the number of levels. IT HAS TO BE A PRIME NUMBER.
% 'powerVal' is the length of the register: the length of the resulting
% sequence will be baseVal^(powerVal-1).
% 'ceil' is rounding up. 'rem' is modulu.
