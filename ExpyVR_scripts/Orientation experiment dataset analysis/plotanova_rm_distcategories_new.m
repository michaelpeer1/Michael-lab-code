function [] = plotanova_rm_distcategories(ds, prop, num_categories, remove_errors)
% plotanova_rm_distcategories(ds, prop, num_categories, remove_errors)
%
% A new version of plotanova_rm_distcategories, without distance
% normalization
%
...
%
% num_categories - the number of distance categories
% remove_errors - 1 - remove trials where isCorrectUser = wrong, 0 - do not
% remove
