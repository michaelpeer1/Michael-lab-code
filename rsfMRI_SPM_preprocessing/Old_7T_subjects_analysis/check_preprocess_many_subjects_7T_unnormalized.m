function check_preprocess_many_subjects_7T_unnormalized(preproc_directory)
% check_preprocess_many_subjects_7T_unnormalized(preproc_directory)
% 
% This is a wrapper which runs check_subject_preprocessing_7T_unnormalized on multiple
...
parfor i=1:length(subjects)
    ...
    if ~exist([preproc_directory '\preproc_check\' subjects(i).name '\check.xls'],'file')
        check_subject_preprocessing_7T_unnormalized(preproc_directory,subjects(i).name);
    end
end
