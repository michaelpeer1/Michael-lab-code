function pre_process_7T_subject_2013(func_dirnames, T1_uni_den_dirname, func_wholebrain_dir, output_dir, subject_name, start_from_stage, end_stage)
...
% NIFTI files), name of the T1 image directory and the full-brain functional directory, 
% a name of the output directory (new directory), and the name of the subject
%
% also receives start_from_stage and end_stage:
