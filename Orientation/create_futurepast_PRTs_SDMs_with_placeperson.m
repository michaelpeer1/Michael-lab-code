...
for s=1:num_subjects
    ...
    for i=1:length(vtc_files)
        ...
        vmr.AddPredictor('person'); vmr.SetPredictorValuesFromCondition('person', 'person', 1.0); vmr.ApplyHemodynamicResponseFunctionToPredictor('person');
        vmr.AddPredictor('place'); vmr.SetPredictorValuesFromCondition('place', 'place', 1.0); vmr.ApplyHemodynamicResponseFunctionToPredictor('place');
