function OutVolume = y_Reslice_no_outputfile(InputFile,NewVoxSize,hld, TargetSpace)
% FORMAT OutVolume = y_Reslice_no_outputfile(InputFile,NewVoxSize,hld, TargetSpace)
%
% A function that reslices an image to other dimensions 
%
% Input:
...
% edited by Michael Peer to return the matrix instead of an output file
